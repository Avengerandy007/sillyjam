...
linux:
	g++ -L $(ray_linx) -lraylib $(gamefr_include) -I./External/Raylib/raylib-5.5_linux_amd64/include -I./include ./src/*.cpp ./External/GameFr/src/*.cpp ./External/GameFr/src/util/*.cpp -o build/silly
